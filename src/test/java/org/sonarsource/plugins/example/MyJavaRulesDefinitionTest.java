...
class MyJavaRulesDefinitionTest {
  ...
  @Test
  void test() {
    MyJavaRulesDefinition rulesDefinition = new MyJavaRulesDefinition(new ExamplePluginTest.MockedSonarRuntime());
    ...
    assertThat(repository.rules()).hasSize(JavaRuleList.getChecks().size());
